                    ...
                    <div className="cart-main">
...

                        {
                            cart.cartItems?.map(cartItems=>(
                                    <div key={cartItems._id} className="cart-main-body">

                                     <div className="cart-main-body-div">
                                        <img src={cartItems.image}   alt={cartItems.name} onClick={()=>detail(cartItems._id)} /> 
                                     ...
                                     <div className="cart-main-body-div2"><h5>₹{cartItems.price}</h5></div>
                                     ...
                                     <div className="cart-main-body-div2">
                                        <div style={{color:'green',fontSize:'23px'}}>₹{cartItems.cartQuantity*cartItems.price} </div>
                                     </div>
                                    </div>
                            ))
                        }
